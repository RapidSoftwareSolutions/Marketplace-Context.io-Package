...
$app->post('/api/Context.io/createUserLevelWebhook', function ($request, $response) {

    $settings = $this->settings;
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['consumerKey','consumerSecret','accountId','callbackUrl','failureNotifyUrl']);
    ...
    $query_str = "https://api.context.io/2.0/accounts/{$data['id']}/webhooks";
